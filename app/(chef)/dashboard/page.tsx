...
export default async function DashboardPage() {
  ...
  const todayEarnings = (todayOrders ?? []).reduce((sum, o) => sum + (parseFloat(o.subtotal ?? o.total_amount ?? 0) * 0.9), 0)
  ...
  const weeklyEarnings = Array.from({ length: 7 }, (_, i) => {
    ...
    return dayOrders.reduce((sum, o: any) => sum + (parseFloat(o.subtotal ?? o.total_amount ?? 0) * 0.9), 0)
  })
