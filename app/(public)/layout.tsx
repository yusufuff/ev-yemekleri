/**
 * (public) grup layout — keşfet, aşçı profili, ödeme, sipariş başarı/hata
 * Giriş zorunluluğu yok; basit navbar + içerik.
 */
...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6EF]">
      ...
      {/* İçerik — mobilde bottom nav boşluğu bırak */}
      <main
      ...
      {/* Giriş yapmış kullanıcılara mobil bottom nav */}
      {user && (
